...
// Ensure this points to the CSS file where we added the premium-navbar styles!
  ...
  return (
    <nav className="premium-navbar">
      ...
      <div className="nav-right">
        ...
        >
          <FiPhoneCall className="btn-icon" /> AI Consultation
        </button>

        {/* User Avatar */}
        <Link to="/patient/profile" className="avatar-link">
