...
const Dashboard = () => {
  ...
  {isFirstLogin ? (
    <div className="healing-overlay">
      ...
      <p>
        Before exploring therapies, let our AI understand your body
        and recommend the best healing path for you.
      </p>
      <button
    ...
    <div className="healing-overlay">
      <h2>Welcome Back</h2>
      <p>
        Continue your healing journey and explore recommended therapies.
      </p>
      <button
        className="healing-btn"
        onClick={() => navigate("/therapy-scheduling")}
      >
        Book Therapy
      </button>
    </div>
  ...
  Trusted Ayurvedic experts curated for your healing journey.
</p>
